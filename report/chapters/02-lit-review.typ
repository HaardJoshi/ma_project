...
#figure(
  table(
    ...
    [@zhao2020; @han2023], [BERT / RoBERTa → XGBoost], [Conflates strategic and risk disclosures; predicts occurrence not outcome], [Section-specific semantic splitting; binary CAR classification (H2)],
  ),
